...
const FormCuenta = ({editar=false, cuenta}) => {
  ...
  return (
    <>
      <Button onPress={onOpen} color="success" startContent={<VscDiffAdded />}>Agregar cuenta</Button>
        ...
        <ModalContent className="overflow-y-auto">
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <form onSubmit={handleSubmit((data) => addCuenta(data))} className="flex w-full flex-col gap-4">
                  <div>
